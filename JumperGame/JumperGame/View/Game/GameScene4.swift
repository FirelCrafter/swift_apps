...
class GameScene4: SKScene, ObservableObject, SKPhysicsContactDelegate {
    ...
    let player = SKSpriteNode(imageNamed: "monster5")
    ...
    override func didMove(to view: SKView) {
        ...
        player.physicsBody?.categoryBitMask = ColliderTtype4.player
        player.physicsBody?.collisionBitMask = ColliderTtype4.stair
        player.physicsBody?.contactTestBitMask = ColliderTtype4.stair
        player.physicsBody?.collisionBitMask = ColliderTtype4.stairTop
        player.physicsBody?.contactTestBitMask = ColliderTtype4.stairTop
        player.name = "player"
    ...
    func spawnStairs(x: CGFloat, y: CGFloat, duration: CGFloat) {
        ...
        stair.physicsBody?.contactTestBitMask = ColliderTtype4.stair
        stair.name = "stair"
        ...
        stair1.physicsBody?.contactTestBitMask = ColliderTtype4.stairTop
        stair1.name = "stair1"

...
class GameScene1: SKScene, ObservableObject, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        player.physicsBody?.categoryBitMask = ColliderTtype1.player
        player.physicsBody?.collisionBitMask = ColliderTtype1.stair
        player.physicsBody?.contactTestBitMask = ColliderTtype1.stair
        player.physicsBody?.collisionBitMask = ColliderTtype1.stairTop
        player.physicsBody?.contactTestBitMask = ColliderTtype1.stairTop
        player.name = "player"
    ...
    func spawnStairs(x: CGFloat, y: CGFloat, duration: CGFloat) {
        ...
        stair.physicsBody?.contactTestBitMask = ColliderTtype1.stair
        stair.name = "stair"
        ...
        stair1.physicsBody?.contactTestBitMask = ColliderTtype1.stairTop
        stair1.name = "stair1"

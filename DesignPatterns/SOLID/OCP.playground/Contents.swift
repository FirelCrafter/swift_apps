...
// OCP (Open/Closed Principle) - принцип гласит, что классы должны быть открыты для расширения
// но закрыты для изменение, т.е. сущности могут менять свое поведение без изменения исходного кода

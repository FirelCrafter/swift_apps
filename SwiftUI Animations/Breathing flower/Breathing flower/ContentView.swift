            ...
            ZStack {
                ...
                VStack {
                    ZStack {
                        ...
                        VStack {
                            Image("breath").resizable().frame(width: 32, height: 125)
                    ...
                    Image("bottomFlowers").resizable().aspectRatio(contentMode: .fit).frame(width: 300, height: 400).rotationEffect(.degrees(37))
                        .offset(x: -25, y: 90)
                    
                    Image("bottomFlowers").resizable().aspectRatio(contentMode: .fit).frame(width: 300, height: 400).rotationEffect(.degrees(32))
                        .offset(x: -20, y: 190)
                    }

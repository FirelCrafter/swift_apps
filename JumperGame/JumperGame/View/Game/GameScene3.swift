...
class GameScene3: SKScene, ObservableObject, SKPhysicsContactDelegate {
    ...
    let player = SKSpriteNode(imageNamed: "monster4")
    ...
    override func didMove(to view: SKView) {
        ...
        player.physicsBody?.categoryBitMask = ColliderTtype3.player
        player.physicsBody?.collisionBitMask = ColliderTtype3.stair
        player.physicsBody?.contactTestBitMask = ColliderTtype3.stair
        player.physicsBody?.collisionBitMask = ColliderTtype3.stairTop
        player.physicsBody?.contactTestBitMask = ColliderTtype3.stairTop
        player.name = "player"
    ...
    func spawnStairs(x: CGFloat, y: CGFloat, duration: CGFloat) {
        ...
        stair.physicsBody?.contactTestBitMask = ColliderTtype3.stair
        stair.name = "stair"
        ...
        stair1.physicsBody?.contactTestBitMask = ColliderTtype3.stairTop
        stair1.name = "stair1"

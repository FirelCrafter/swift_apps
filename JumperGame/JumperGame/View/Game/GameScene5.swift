...
//  JumperGame
//
//  Created by Михаил Щербаков on 03.11.2021.
//
...
class GameScene5: SKScene, ObservableObject, SKPhysicsContactDelegate {
    ...
    let player = SKSpriteNode(imageNamed: "monster6")
    ...
    override func didMove(to view: SKView) {
        ...
        player.physicsBody?.categoryBitMask = ColliderTtype5.player
        player.physicsBody?.collisionBitMask = ColliderTtype5.stair
        player.physicsBody?.contactTestBitMask = ColliderTtype5.stair
        player.physicsBody?.collisionBitMask = ColliderTtype5.stairTop
        player.physicsBody?.contactTestBitMask = ColliderTtype5.stairTop
        player.name = "player"
    ...
    func spawnStairs(x: CGFloat, y: CGFloat, duration: CGFloat) {
        ...
        stair.physicsBody?.contactTestBitMask = ColliderTtype5.stair
        stair.name = "stair"
        ...
        stair1.physicsBody?.contactTestBitMask = ColliderTtype5.stairTop
        stair1.name = "stair1"

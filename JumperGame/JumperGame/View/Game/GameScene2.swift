...
class GameScene2: SKScene, ObservableObject, SKPhysicsContactDelegate {
    ...
    let player = SKSpriteNode(imageNamed: "monster3")
    ...
    override func didMove(to view: SKView) {
        ...
        player.physicsBody?.categoryBitMask = ColliderTtype2.player
        player.physicsBody?.collisionBitMask = ColliderTtype2.stair
        player.physicsBody?.contactTestBitMask = ColliderTtype2.stair
        player.physicsBody?.collisionBitMask = ColliderTtype2.stairTop
        player.physicsBody?.contactTestBitMask = ColliderTtype2.stairTop
        player.name = "player"
    ...
    func spawnStairs(x: CGFloat, y: CGFloat, duration: CGFloat) {
        ...
        stair.physicsBody?.contactTestBitMask = ColliderTtype2.stair
        stair.name = "stair"
        ...
        stair1.physicsBody?.contactTestBitMask = ColliderTtype2.stairTop
        stair1.name = "stair1"
